...
class GroupOp(paddle.nn.Layer):
    ...
    def forward(self, parameter_0, conv2d_0):
        ...
        # shape: ([S0, 320, (S3-1)/2+1, (S3-1)/2+1]) <- ([S0, 320, (S3-1)/2+1, (S3-1)/2+1], [1, 320, 1, 1])
        #  data: (None) <- (None, None)
        ...
        # shape: ([2]) <- ([S0, 320, (S3-1)/2+1, (S3-1)/2+1])
        #  data: ([S0*32, -1]) <- (None)
        ...
        # shape: ([S0*32, ((S3-1)/2+1)*((S3-1)/2+1)*10], [0, S0, 320, (S3-1)/2+1, (S3-1)/2+1]) <- ([S0, 320, (S3-1)/2+1, (S3-1)/2+1], [2])
        ...
        # shape: () <- ([S0, 320, (S3-1)/2+1, (S3-1)/2+1], [S0, 320, (S3-1)/2+1, (S3-1)/2+1], [S0*32, ((S3-1)/2+1)*((S3-1)/2+1)*10], [S0*32, ((S3-1)/2+1)*((S3-1)/2+1)*10])
