...
class GroupOp(paddle.nn.Layer):
    ...
    def forward(self, parameter_0, conv2d_0, group_0, group_1):
        ...
        #  type: (-1x-1xf32, 0x-1x1920x-1x-1xi64) <- (-1x1920x-1x-1xf32, 2xi64)
        # shape: ([S0*32, S5*S5*60], [0, S0, 1920, S5, S5]) <- ([S0, 1920, S5, S5], [2])
        ...
        #  type: () <- (-1x1920x-1x-1xf16, -1x1920x-1x-1xf32, -1x-1xf32, -1x-1xf32)
        # shape: () <- ([S0, 1920, S5, S5], [S0, 1920, S5, S5], [S0*32, S5*S5*60], [S0*32, S5*S5*60])
