...
class GroupOp(paddle.nn.Layer):
    ...
    def forward(self, parameter_0, conv2d_0, group_0):
        ...
        #  type: () <- (-1x1280x-1x-1xf16, -1x1280x-1x-1xf32, -1x-1xf32, -1x-1xf32)
        # shape: () <- ([S0, 1280, (S3-1)/8+1, (S3-1)/8+1], [S0, 1280, (S3-1)/8+1, (S3-1)/8+1], [S0*32, ((S3-1)/8+1)*((S3-1)/8+1)*40], [S0*32, ((S3-1)/8+1)*((S3-1)/8+1)*40])
