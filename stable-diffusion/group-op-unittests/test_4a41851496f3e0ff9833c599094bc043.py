...
class GroupOp(paddle.nn.Layer):
    ...
    def forward(self, parameter_0, conv2d_0, matmul_0, parameter_1):
        ...
        # shape: ([S0, 1280, (S3-1)/4+1, (S3-1)/4+1]) <- ([S0, 1280, (S3-1)/4+1, (S3-1)/4+1], [1, 1280, 1, 1])
        #  data: (None) <- (None, None)
        ...
        # shape: ([2]) <- ([S0, 1280, (S3-1)/4+1, (S3-1)/4+1])
        #  data: ([S0*32, -1]) <- (None)
        ...
        # shape: ([S0*32, ((S3-1)/4+1)*((S3-1)/4+1)*40], [0, S0, 1280, (S3-1)/4+1, (S3-1)/4+1]) <- ([S0, 1280, (S3-1)/4+1, (S3-1)/4+1], [2])
        ...
        # shape: () <- ([S0, 1280, (S3-1)/4+1, (S3-1)/4+1], [S0*32, ((S3-1)/4+1)*((S3-1)/4+1)*40], [S0*32, ((S3-1)/4+1)*((S3-1)/4+1)*40])
        #  data: () <- (None, None, None)
