...
class GroupOp(paddle.nn.Layer):
    ...
    def forward(self, matmul_0, parameter_0, group_0, parameter_1, parameter_2):
        ...
        #  type: (-1x-1x1280xf16) <- (-1x-1x1280xf16, 1280xf16)
        # shape: ([S0, ((S3-1)/4+1)*((S3-1)/4+1), 1280]) <- ([S0, ((S3-1)/4+1)*((S3-1)/4+1), 1280], [1280])
        #  data: (None) <- (None, None)
        ...
        if FastReturn(2):
            return group_0, parameter_1, parameter_2, scale_0
        ...
        #  type: (-1x-1x1280xf32) <- (-1x-1x1280xf32, -1x-1x1xf32)
        # shape: ([S0, ((S3-1)/4+1)*((S3-1)/4+1), 1280]) <- ([S0, ((S3-1)/4+1)*((S3-1)/4+1), 1280], [S0, ((S3-1)/4+1)*((S3-1)/4+1), 1])
        #  data: (None) <- (None, None)
        ...
        #  type: (1xi64) <- (-1x-1x1280xf16)
        # shape: ([1]) <- ([S0, ((S3-1)/4+1)*((S3-1)/4+1), 1280])
        #  data: ([1280]) <- (None)
        generate_shape_0 = [1280] # inputs: add_1
        ...
        if FastReturn(18):
            return parameter_2, add_1, multiply_1, cast_1

        #  type: (-1x-1x1280xf32) <- (-1x-1x1280xf32, -1xf32)
        # shape: ([S0, ((S3-1)/4+1)*((S3-1)/4+1), 1280]) <- ([S0, ((S3-1)/4+1)*((S3-1)/4+1), 1280], [1280])
        #  data: (None) <- (None, None)
        multiply_2 = multiply_1 * cast_1

        if FastReturn(19):
            return parameter_2, add_1, multiply_2
        ...
        if FastReturn(20):
            return add_1, multiply_2, cast_2
