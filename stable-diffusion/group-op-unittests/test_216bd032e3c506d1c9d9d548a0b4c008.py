...
class GroupOp(paddle.nn.Layer):
    ...
    def forward(self, parameter_0, conv2d_0):
        ...
        generate_shape_0 = [transpose_0.shape[0], (transpose_0.shape[2] * transpose_0.shape[2]), 640] # inputs: transpose_0
        ...
        # shape: ([1]) <- ([S0, ((S3-1)/2+1)*((S3-1)/2+1), 640])
        #  data: ([640]) <- (None)
        generate_shape_1 = [640] # inputs: reshape_1
