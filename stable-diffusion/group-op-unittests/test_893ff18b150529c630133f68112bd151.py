...
class GroupOp(paddle.nn.Layer):
    ...
    def forward(self, matmul_0, parameter_0, group_0, parameter_1, parameter_2):
        ...
        #  type: (-1x-1x640xf16) <- (-1x-1x640xf16, 640xf16)
        # shape: ([S0, S6*S6, 640]) <- ([S0, S6*S6, 640], [640])
        #  data: (None) <- (None, None)
        ...
        #  type: (-1x-1x640xf16) <- (-1x-1x640xf16)
        ...
        #  type: (-1x-1x640xf32) <- (-1x-1x640xf32, -1x-1x1xf32)
        # shape: ([S0, S6*S6, 640]) <- ([S0, S6*S6, 640], [S0, S6*S6, 1])
        #  data: (None) <- (None, None)
        ...
        #  type: (1xi64) <- (-1x-1x640xf16)
        # shape: ([1]) <- ([S0, S6*S6, 640])
        #  data: ([640]) <- (None)
        generate_shape_0 = [640] # inputs: add_1
        ...
        #  type: (-1x-1x640xf32) <- (-1x-1x640xf32, -1xf32)
        # shape: ([S0, S6*S6, 640]) <- ([S0, S6*S6, 640], [640])
        #  data: (None) <- (None, None)
