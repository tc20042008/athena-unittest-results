...
class GroupOp(paddle.nn.Layer):
    ...
    def forward(self, parameter_0, conv2d_0, group_0):
        ...
        # shape: ([S0, 1280, S6, S6]) <- ([S0, 1280, S6, S6], [1, 1280, 1, 1])
        #  data: (None) <- (None, None)
        ...
        # shape: ([S0*32, S6*S6*60], [0, S0, 1920, S6, S6]) <- ([S0, 1920, S6, S6], [2])
        ...
        # shape: () <- ([S0, 1920, S6, S6], [S0, 1920, S6, S6], [S0*32, S6*S6*60], [S0*32, S6*S6*60])
