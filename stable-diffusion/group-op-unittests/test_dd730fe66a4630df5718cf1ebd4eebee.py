...
class GroupOp(paddle.nn.Layer):
    ...
    def forward(self, group_0, full_int_array_0, shape_0, group_1, full_int_array_1, shape_1, group_2, parameter_0, parameter_1):
        ...
        # shape: ([S0*32, 1]) <- ([S0*32, ((S3-1)/8+1)*((S3-1)/8+1)*40])
        #  data: (None) <- (None)
        ...
        # shape: ([1]) <- ([2], [1, 1])
        #  data: (None) <- ([S0*32, ((S3-1)/8+1)*((S3-1)/8+1)*40], [1])
        ...
        # shape: ([S0*32, ((S3-1)/8+1)*((S3-1)/8+1)*40]) <- ([S0*32, ((S3-1)/8+1)*((S3-1)/8+1)*40], [S0*32, 1])
        #  data: (None) <- (None, None)
        ...
        # shape: ([S0, 1280, (S3-1)/8+1, (S3-1)/8+1]) <- ([S0, 1280, (S3-1)/8+1, (S3-1)/8+1], [1280, 1, 1])
        #  data: (None) <- (None, None)
        ...
        # shape: ([S0, 1280, (S3-1)/8+1, (S3-1)/8+1]) <- ([1], [S0, 1280, (S3-1)/8+1, (S3-1)/8+1])
        #  data: (None) <- ([1], None)
        add_2 = full_2 + exp_0
