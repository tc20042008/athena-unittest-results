...
class FusionOp(paddle.nn.Layer):
    ...
    def forward(self, fusion_0, fusion_1, fusion_2, fusion_3, fusion_4, fusion_5, parameter_0, parameter_1):
        ...
        #  type: (2xi64) <- (-1x-1xf32)
        # shape: ([2]) <- ([S0*32, ((S3-1)/8+1)*((S3-1)/8+1)*40])
        #  data: ([S0*32, ((S3-1)/8+1)*((S3-1)/8+1)*40]) <- (None)
        ...
        # shape: ([S0*32, ((S3-1)/8+1)*((S3-1)/8+1)*40]) <- ([S0*32, 1], [2])
        #  data: (None) <- (None, [S0*32, ((S3-1)/8+1)*((S3-1)/8+1)*40])
        ...
        # shape: ([S0, 1280, (S3-1)/8+1, (S3-1)/8+1], [0, S0*32, ((S3-1)/8+1)*((S3-1)/8+1)*40]) <- ([S0*32, ((S3-1)/8+1)*((S3-1)/8+1)*40], [4])
        #  data: (None, None) <- (None, [S0, 1280, (S3-1)/8+1, (S3-1)/8+1])
        ...
        # shape: ([S0, 1280, (S3-1)/8+1, (S3-1)/8+1]) <- ([1280, 1, 1], [4])
        ...
        # shape: ([4]) <- ([S0, 1280, (S3-1)/8+1, (S3-1)/8+1])
        #  data: ([S0, 1280, (S3-1)/8+1, (S3-1)/8+1]) <- (None)
        generate_shape_9 = [exp_0.shape[0], 1280, exp_0.shape[3], exp_0.shape[3]] # inputs: exp_0

        if FastReturn(41):
            return cast_3, full_2, exp_0, generate_shape_9

        #  type: (-1x-1x-1x-1xf32) <- (1xf32, 4xi64)
        # shape: ([S0, 1280, (S3-1)/8+1, (S3-1)/8+1]) <- ([1], [4])
        #  data: (None) <- ([1], [S0, 1280, (S3-1)/8+1, (S3-1)/8+1])
        ...
        # shape: ([4]) <- ([S0, 1280, (S3-1)/8+1, (S3-1)/8+1])
        #  data: ([S0, 1280, (S3-1)/8+1, (S3-1)/8+1]) <- (None)
        generate_shape_10 = [add_2.shape[0], 1280, add_2.shape[3], add_2.shape[3]] # inputs: add_2
        ...
        # shape: () <- ([S0, 1280, (S3-1)/8+1, (S3-1)/8+1])
        #  data: () <- (None)
        return cast_4
