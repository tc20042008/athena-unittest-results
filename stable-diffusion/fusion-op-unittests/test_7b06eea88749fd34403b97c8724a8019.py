...
class FusionOp(paddle.nn.Layer):
    ...
    def forward(self, fusion_0, fusion_1, fusion_2, fusion_3, fusion_4, fusion_5, parameter_0, parameter_1):
        ...
        #  type: (2xi64) <- (-1x-1xf32)
        # shape: ([2]) <- ([S0*32, ((S3-1)/2+1)*((S3-1)/2+1)*20])
        #  data: ([S0*32, ((S3-1)/2+1)*((S3-1)/2+1)*20]) <- (None)
        ...
        # shape: ([S0*32, ((S3-1)/2+1)*((S3-1)/2+1)*20]) <- ([S0*32, 1], [2])
        #  data: (None) <- (None, [S0*32, ((S3-1)/2+1)*((S3-1)/2+1)*20])
        ...
        #  type: (-1x-1xf32) <- (-1x-1xf32, -1x-1xf32)
        # shape: ([S0*32, ((S3-1)/2+1)*((S3-1)/2+1)*20]) <- ([S0*32, ((S3-1)/2+1)*((S3-1)/2+1)*20], [S0*32, ((S3-1)/2+1)*((S3-1)/2+1)*20])
        #  data: (None) <- (None, None)
        ...
        # shape: ([4]) <- ([S0, 640, (S3-1)/2+1, (S3-1)/2+1])
        #  data: ([S0, 640, (S3-1)/2+1, (S3-1)/2+1]) <- (None)
        ...
        # shape: ([S0, 640, (S3-1)/2+1, (S3-1)/2+1], [0, S0*32, ((S3-1)/2+1)*((S3-1)/2+1)*20]) <- ([S0*32, ((S3-1)/2+1)*((S3-1)/2+1)*20], [4])
        #  data: (None, None) <- (None, [S0, 640, (S3-1)/2+1, (S3-1)/2+1])
        ...
        # shape: ([S0, 640, (S3-1)/2+1, (S3-1)/2+1]) <- ([640, 1, 1], [4])
        #  data: (None) <- (None, [S0, 640, (S3-1)/2+1, (S3-1)/2+1])
        ...
        # shape: ([S0, 640, (S3-1)/2+1, (S3-1)/2+1]) <- ([S0, 640, (S3-1)/2+1, (S3-1)/2+1], [S0, 640, (S3-1)/2+1, (S3-1)/2+1])
        #  data: (None) <- (None, None)
        ...
        # shape: ([S0, 640, (S3-1)/2+1, (S3-1)/2+1]) <- ([S0, 640, (S3-1)/2+1, (S3-1)/2+1])
        #  data: (None) <- (None)
        ...
        # shape: ([S0, 640, (S3-1)/2+1, (S3-1)/2+1]) <- ([1], [4])
        #  data: (None) <- ([1], [S0, 640, (S3-1)/2+1, (S3-1)/2+1])
        ...
        # shape: () <- ([S0, 640, (S3-1)/2+1, (S3-1)/2+1])
        #  data: () <- (None)
        return cast_4
