...
class FusionOp(paddle.nn.Layer):
    ...
    def forward(self, fusion_0, fusion_1, fusion_2, fusion_3, fusion_4, fusion_5, parameter_0, parameter_1):
        ...
        #  type: (2xi64) <- (-1x-1xf32)
        # shape: ([2]) <- ([S0*32, S3*S3*10])
        #  data: ([S0*32, S3*S3*10]) <- (None)
        ...
        # shape: ([S0*32, S3*S3*10]) <- ([S0*32, 1], [2])
        #  data: (None) <- (None, [S0*32, S3*S3*10])
        ...
        # shape: ([2]) <- ([S0, 320, S3, S3])
        #  data: ([S0*32, S3*S3*10]) <- (None)
        generate_shape_5 = [(fusion_0.shape[0] * 32), (fusion_0.shape[3] * fusion_0.shape[3] * 10)] # inputs: fusion_0
        ...
        generate_shape_6 = [fusion_0.shape[0], 320, fusion_0.shape[3], fusion_0.shape[3]] # inputs: fusion_0
        ...
        # shape: ([4]) <- ([S0, 320, S3, S3])
        #  data: ([S0, 320, S3, S3]) <- (None)
        generate_shape_7 = [fusion_0.shape[0], 320, fusion_0.shape[3], fusion_0.shape[3]] # inputs: fusion_0

        if FastReturn(28):
            return fusion_0, parameter_1, reshape_0, cast_0, generate_shape_7

        #  type: (-1x-1x-1x-1xf32) <- (320x1x1xf32, 4xi64)
        # shape: ([S0, 320, S3, S3]) <- ([320, 1, 1], [4])
        ...
        # shape: ([4]) <- ([S0, 320, S3, S3])
        #  data: ([S0, 320, S3, S3]) <- (None)
        generate_shape_8 = [fusion_0.shape[0], 320, fusion_0.shape[3], fusion_0.shape[3]] # inputs: fusion_0
        ...
        # shape: ([4]) <- ([S0, 320, S3, S3])
        #  data: ([S0, 320, S3, S3]) <- (None)
        generate_shape_9 = [fusion_0.shape[0], 320, fusion_0.shape[3], fusion_0.shape[3]] # inputs: fusion_0

        if FastReturn(41):
            return fusion_0, cast_3, full_2, exp_0, generate_shape_9

        #  type: (-1x-1x-1x-1xf32) <- (1xf32, 4xi64)
        # shape: ([S0, 320, S3, S3]) <- ([1], [4])
        #  data: (None) <- ([1], [S0, 320, S3, S3])
        ...
        # shape: ([4]) <- ([S0, 320, S3, S3])
        #  data: ([S0, 320, S3, S3]) <- (None)
        generate_shape_10 = [fusion_0.shape[0], 320, fusion_0.shape[3], fusion_0.shape[3]] # inputs: fusion_0
