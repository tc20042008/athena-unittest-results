...
class FusionOp(paddle.nn.Layer):
    ...
    def forward(self, matmul_0, parameter_0):
        ...
        # shape: ([3]) <- ([S0, ((S3-1)/2+1)*((S3-1)/2+1), 5120])
        #  data: ([S0, ((S3-1)/2+1)*((S3-1)/2+1), 5120]) <- (None)
        generate_shape_0 = [matmul_0.shape[0], matmul_0.shape[1], 5120] # inputs: matmul_0

        if FastReturn(1):
            return matmul_0, parameter_0, generate_shape_0

        #  type: (-1x-1x-1xf16) <- (5120xf16, 3xi64)
        # shape: ([S0, ((S3-1)/2+1)*((S3-1)/2+1), 5120]) <- ([5120], [3])
        #  data: (None) <- (None, [S0, ((S3-1)/2+1)*((S3-1)/2+1), 5120])
        ...
        # shape: ([S0, ((S3-1)/2+1)*((S3-1)/2+1), 5120]) <- ([S0, ((S3-1)/2+1)*((S3-1)/2+1), 5120], [S0, ((S3-1)/2+1)*((S3-1)/2+1), 5120])
        #  data: (None) <- (None, None)
        ...
        # shape: ([S0, ((S3-1)/2+1)*((S3-1)/2+1), 2560]) <- ([S0, ((S3-1)/2+1)*((S3-1)/2+1), 5120])
        #  data: (None) <- (None)
        ...
        # shape: ([3]) <- ([S0, ((S3-1)/2+1)*((S3-1)/2+1), 2560])
        #  data: ([S0, ((S3-1)/2+1)*((S3-1)/2+1), 2560]) <- (None)
        generate_shape_1 = [slice_0.shape[0], slice_0.shape[1], 2560] # inputs: slice_0

        if FastReturn(9):
            return slice_0, slice_1, full_0, full_1, full_2, generate_shape_1

        #  type: (-1x-1x-1xf16) <- (xf16, 3xi64)
        # shape: ([S0, ((S3-1)/2+1)*((S3-1)/2+1), 2560]) <- ([], [3])
        #  data: (None) <- ([0], [S0, ((S3-1)/2+1)*((S3-1)/2+1), 2560])
        ...
        # shape: ([S0, ((S3-1)/2+1)*((S3-1)/2+1), 2560]) <- ([S0, ((S3-1)/2+1)*((S3-1)/2+1), 2560], [S0, ((S3-1)/2+1)*((S3-1)/2+1), 2560])
        #  data: (None) <- (None, None)
        ...
        # shape: ([S0, ((S3-1)/2+1)*((S3-1)/2+1), 2560]) <- ([S0, ((S3-1)/2+1)*((S3-1)/2+1), 2560])
        #  data: (None) <- (None)
        ...
        # shape: ([3]) <- ([S0, ((S3-1)/2+1)*((S3-1)/2+1), 2560])
        #  data: ([S0, ((S3-1)/2+1)*((S3-1)/2+1), 2560]) <- (None)
        generate_shape_2 = [erf_0.shape[0], erf_0.shape[1], 2560] # inputs: erf_0
        ...
        # shape: ([3]) <- ([S0, ((S3-1)/2+1)*((S3-1)/2+1), 2560])
        #  data: ([S0, ((S3-1)/2+1)*((S3-1)/2+1), 2560]) <- (None)
        generate_shape_3 = [slice_0.shape[0], slice_0.shape[1], 2560] # inputs: slice_0
        ...
        #  type: () <- (-1x-1x2560xf16)
        # shape: () <- ([S0, ((S3-1)/2+1)*((S3-1)/2+1), 2560])
        #  data: () <- (None)
        return multiply_3
