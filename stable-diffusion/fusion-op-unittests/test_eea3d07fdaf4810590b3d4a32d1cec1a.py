...
class FusionOp(paddle.nn.Layer):
    ...
    def forward(self, fusion_0, fusion_1, fusion_2, parameter_0, parameter_1):
        ...
        generate_shape_2 = [fusion_2.shape[0], fusion_2.shape[1], 320] # inputs: fusion_2
        ...
        # shape: ([3]) <- ([S0, S3*S3, 320])
        #  data: ([S0, S3*S3, 320]) <- (None)
        generate_shape_3 = [multiply_0.shape[0], multiply_0.shape[1], 320] # inputs: multiply_0
        ...
        # shape: ([3]) <- ([S0, S3*S3, 320])
        #  data: ([S0, S3*S3, 320]) <- (None)
        generate_shape_4 = [multiply_1.shape[0], multiply_1.shape[1], 320] # inputs: multiply_1
