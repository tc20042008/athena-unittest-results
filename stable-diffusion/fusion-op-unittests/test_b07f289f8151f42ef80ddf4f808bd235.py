...
class FusionOp(paddle.nn.Layer):
    ...
    def forward(self, fusion_0, fusion_1, fusion_2, fusion_3, fusion_4, fusion_5, parameter_0, parameter_1):
        ...
        #  type: (2xi64) <- (-1x-1xf32)
        # shape: ([2]) <- ([S0*32, S5*S5*60])
        #  data: ([S0*32, S5*S5*60]) <- (None)
        ...
        # shape: ([S0*32, S5*S5*60]) <- ([S0*32, 1], [2])
        #  data: (None) <- (None, [S0*32, S5*S5*60])
        ...
        #  type: (-1x-1xf32) <- (-1x-1xf32, -1x-1xf32)
        # shape: ([S0*32, S5*S5*60]) <- ([S0*32, S5*S5*60], [S0*32, S5*S5*60])
        #  data: (None) <- (None, None)
        ...
        # shape: ([S0, 1920, S5, S5]) <- ([1920, 1, 1], [4])
        #  data: (None) <- (None, [S0, 1920, S5, S5])
        ...
        # shape: ([S0, 1920, S5, S5]) <- ([1], [4])
        #  data: (None) <- ([1], [S0, 1920, S5, S5])
