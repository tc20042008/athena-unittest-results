...
class FusionOp(paddle.nn.Layer):
    ...
    def forward(self, fusion_0, fusion_1, parameter_0, parameter_1):
        ...
        # shape: ([3]) <- ([S0, ((S3-1)/8+1)*((S3-1)/8+1), 1])
        #  data: ([S0, ((S3-1)/8+1)*((S3-1)/8+1), 1]) <- (None)
        ...
        # shape: ([S0, ((S3-1)/8+1)*((S3-1)/8+1), 1]) <- ([], [3])
        #  data: (None) <- ([1280], [S0, ((S3-1)/8+1)*((S3-1)/8+1), 1])
        ...
        # shape: ([S0, ((S3-1)/8+1)*((S3-1)/8+1), 1]) <- ([S0, ((S3-1)/8+1)*((S3-1)/8+1), 1], [S0, ((S3-1)/8+1)*((S3-1)/8+1), 1])
        #  data: (None) <- (None, None)
        ...
        # shape: ([S0, ((S3-1)/8+1)*((S3-1)/8+1), 1280]) <- ([S0, ((S3-1)/8+1)*((S3-1)/8+1), 1], [3])
        ...
        #  type: (-1x-1x-1xf32) <- (xf32, 3xi64)
        # shape: ([S0, ((S3-1)/8+1)*((S3-1)/8+1), 1]) <- ([], [3])
        #  data: (None) <- ([0], [S0, ((S3-1)/8+1)*((S3-1)/8+1), 1])
