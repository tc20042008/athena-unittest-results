...
class FusionOp(paddle.nn.Layer):
    ...
    def forward(self, parameter_0, conv2d_0, fusion_0, fusion_1):
        ...
        #  type: (-1x1920x-1x-1xf16) <- (-1x1280x-1x-1xf16, -1x640x-1x-1xf16)
        # shape: ([S0, 1920, S5, S5]) <- ([S0, 1280, S5, S5], [S0, 640, (S3-1)/4+1, (S3-1)/4+1])
        #  data: (None) <- (None, None)
        ...
        #  type: (-1x1920x-1x-1xf16) <- (-1x1920x-1x-1xf16)
