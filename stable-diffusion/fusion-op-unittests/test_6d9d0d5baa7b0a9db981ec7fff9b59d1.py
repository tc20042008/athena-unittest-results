...
class FusionOp(paddle.nn.Layer):
    ...
    def forward(self, matmul_0, parameter_0):
        ...
        # shape: ([3]) <- ([S0, S6*S6, 5120])
        #  data: ([S0, S6*S6, 5120]) <- (None)
        ...
        # shape: ([S0, S6*S6, 5120]) <- ([5120], [3])
        #  data: (None) <- (None, [S0, S6*S6, 5120])
        ...
        # shape: ([S0, S6*S6, 5120]) <- ([S0, S6*S6, 5120], [S0, S6*S6, 5120])
        #  data: (None) <- (None, None)
        ...
        # shape: ([3]) <- ([S0, S6*S6, 2560])
        #  data: ([S0, S6*S6, 2560]) <- (None)
        ...
        # shape: ([S0, S6*S6, 2560]) <- ([], [3])
        #  data: (None) <- ([0], [S0, S6*S6, 2560])
