...
class FusionOp(paddle.nn.Layer):
    ...
    def forward(self, fusion_0, fusion_1, fusion_2, fusion_3, fusion_4, fusion_5, parameter_0, parameter_1):
        ...
        #  type: (2xi64) <- (-1x-1xf32)
        # shape: ([2]) <- ([S0*32, S3*S3*30])
        #  data: ([S0*32, S3*S3*30]) <- (None)
        ...
        # shape: ([S0*32, S3*S3*30]) <- ([S0*32, 1], [2])
        #  data: (None) <- (None, [S0*32, S3*S3*30])
        ...
        # shape: ([4]) <- ([S0, 960, S3, S3])
        #  data: ([S0, 960, S3, S3]) <- (None)
        ...
        # shape: ([S0, 960, S3, S3], [0, S0*32, S3*S3*30]) <- ([S0*32, S3*S3*30], [4])
        #  data: (None, None) <- (None, [S0, 960, S3, S3])
        ...
        # shape: ([S0, 960, S3, S3]) <- ([960, 1, 1], [4])
        #  data: (None) <- (None, [S0, 960, S3, S3])
        ...
        # shape: ([S0, 960, S3, S3]) <- ([S0, 960, S3, S3], [S0, 960, S3, S3])
        #  data: (None) <- (None, None)
        ...
        # shape: ([S0, 960, S3, S3]) <- ([1], [4])
        #  data: (None) <- ([1], [S0, 960, S3, S3])
