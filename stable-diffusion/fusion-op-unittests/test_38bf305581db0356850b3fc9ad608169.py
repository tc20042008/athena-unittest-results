...
class FusionOp(paddle.nn.Layer):
    ...
    def forward(self, fusion_0, fusion_1, parameter_0, parameter_1):
        ...
        #  type: (-1x-1x1280xf32) <- (-1x-1x1280xf16)
        # shape: ([S0, ((S3-1)/4+1)*((S3-1)/4+1), 1280]) <- ([S0, ((S3-1)/4+1)*((S3-1)/4+1), 1280])
        #  data: (None) <- (None)
        ...
        # shape: ([]) <- ()
        #  data: ([1280]) <- ()
        full_0 = paddle.full(shape=[], dtype='float32', fill_value=1280)

        if FastReturn(2):
            return fusion_1, parameter_0, parameter_1, cast_0, full_0

        #  type: (3xi64) <- (-1x-1x1xf32)
        # shape: ([3]) <- ([S0, ((S3-1)/4+1)*((S3-1)/4+1), 1])
        #  data: ([S0, ((S3-1)/4+1)*((S3-1)/4+1), 1]) <- (None)
        ...
        # shape: ([S0, ((S3-1)/4+1)*((S3-1)/4+1), 1]) <- ([], [3])
        #  data: (None) <- ([1280], [S0, ((S3-1)/4+1)*((S3-1)/4+1), 1])
        ...
        # shape: ([S0, ((S3-1)/4+1)*((S3-1)/4+1), 1]) <- ([S0, ((S3-1)/4+1)*((S3-1)/4+1), 1], [S0, ((S3-1)/4+1)*((S3-1)/4+1), 1])
        #  data: (None) <- (None, None)
        ...
        #  type: (3xi64) <- (-1x-1x1280xf32)
        # shape: ([3]) <- ([S0, ((S3-1)/4+1)*((S3-1)/4+1), 1280])
        #  data: ([S0, ((S3-1)/4+1)*((S3-1)/4+1), 1280]) <- (None)
        generate_shape_1 = [cast_0.shape[0], cast_0.shape[1], 1280] # inputs: cast_0

        if FastReturn(6):
            return parameter_0, parameter_1, cast_0, divide_0, generate_shape_1

        #  type: (-1x-1x-1xf32) <- (-1x-1x1xf32, 3xi64)
        # shape: ([S0, ((S3-1)/4+1)*((S3-1)/4+1), 1280]) <- ([S0, ((S3-1)/4+1)*((S3-1)/4+1), 1], [3])
        #  data: (None) <- (None, [S0, ((S3-1)/4+1)*((S3-1)/4+1), 1280])
        expand_1 = paddle.expand(divide_0, generate_shape_1)

        if FastReturn(7):
            return parameter_0, parameter_1, cast_0, expand_1

        #  type: (-1x-1x1280xf32) <- (-1x-1x1280xf32, -1x-1x-1xf32)
        # shape: ([S0, ((S3-1)/4+1)*((S3-1)/4+1), 1280]) <- ([S0, ((S3-1)/4+1)*((S3-1)/4+1), 1280], [S0, ((S3-1)/4+1)*((S3-1)/4+1), 1280])
        #  data: (None) <- (None, None)
        ...
        #  type: (-1x-1x1280xf32) <- (-1x-1x1280xf32, -1x-1x1280xf32)
        # shape: ([S0, ((S3-1)/4+1)*((S3-1)/4+1), 1280]) <- ([S0, ((S3-1)/4+1)*((S3-1)/4+1), 1280], [S0, ((S3-1)/4+1)*((S3-1)/4+1), 1280])
        #  data: (None) <- (None, None)
        ...
        #  type: (-1x-1x1xf32) <- (-1x-1x1280xf32)
        # shape: ([S0, ((S3-1)/4+1)*((S3-1)/4+1), 1]) <- ([S0, ((S3-1)/4+1)*((S3-1)/4+1), 1280])
        #  data: (None) <- (None)
        ...
        # shape: ([]) <- ()
        #  data: ([1280]) <- ()
        full_1 = paddle.full(shape=[], dtype='float32', fill_value=1280)
        ...
        #  type: (-1x-1x-1xf32) <- (xf32, 3xi64)
        # shape: ([S0, ((S3-1)/4+1)*((S3-1)/4+1), 1]) <- ([], [3])
        #  data: (None) <- ([0], [S0, ((S3-1)/4+1)*((S3-1)/4+1), 1])
        ...
        # shape: ([S0, ((S3-1)/4+1)*((S3-1)/4+1), 1]) <- ([S0, ((S3-1)/4+1)*((S3-1)/4+1), 1])
        #  data: (None) <- (None)
        ...
        # shape: ([3]) <- ([S0, ((S3-1)/4+1)*((S3-1)/4+1), 1280])
        #  data: ([S0, ((S3-1)/4+1)*((S3-1)/4+1), 1280]) <- (None)
        generate_shape_4 = [subtract_0.shape[0], subtract_0.shape[1], 1280] # inputs: subtract_0
        ...
        # shape: ([3]) <- ([S0, ((S3-1)/4+1)*((S3-1)/4+1), 1280])
        #  data: ([S0, ((S3-1)/4+1)*((S3-1)/4+1), 1280]) <- (None)
        generate_shape_5 = [multiply_1.shape[0], multiply_1.shape[1], 1280] # inputs: multiply_1

        if FastReturn(24):
            return parameter_1, multiply_1, cast_1, generate_shape_5

        #  type: (-1x-1x-1xf32) <- (-1xf32, 3xi64)
        # shape: ([S0, ((S3-1)/4+1)*((S3-1)/4+1), 1280]) <- ([1280], [3])
        #  data: (None) <- (None, [S0, ((S3-1)/4+1)*((S3-1)/4+1), 1280])
        ...
        # shape: ([3]) <- ([S0, ((S3-1)/4+1)*((S3-1)/4+1), 1280])
        #  data: ([S0, ((S3-1)/4+1)*((S3-1)/4+1), 1280]) <- (None)
        generate_shape_6 = [multiply_2.shape[0], multiply_2.shape[1], 1280] # inputs: multiply_2
        ...
        #  type: (-1x-1x1280xf16) <- (-1x-1x1280xf32)
        # shape: ([S0, ((S3-1)/4+1)*((S3-1)/4+1), 1280]) <- ([S0, ((S3-1)/4+1)*((S3-1)/4+1), 1280])
        #  data: (None) <- (None)
        cast_3 = paddle.cast(add_1, dtype='float16')

        #  type: () <- (-1x-1x1280xf16)
        # shape: () <- ([S0, ((S3-1)/4+1)*((S3-1)/4+1), 1280])
        #  data: () <- (None)
        return cast_3
