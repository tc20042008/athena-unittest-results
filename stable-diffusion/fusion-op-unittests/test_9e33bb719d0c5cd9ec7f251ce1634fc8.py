...
class FusionOp(paddle.nn.Layer):
    ...
    def forward(self, matmul_0, parameter_0):
        ...
        # shape: ([3]) <- ([S0, S5*S5, 10240])
        #  data: ([S0, S5*S5, 10240]) <- (None)
        ...
        # shape: ([S0, S5*S5, 10240]) <- ([10240], [3])
        #  data: (None) <- (None, [S0, S5*S5, 10240])
        ...
        # shape: ([S0, S5*S5, 10240]) <- ([S0, S5*S5, 10240], [S0, S5*S5, 10240])
        #  data: (None) <- (None, None)
        ...
        # shape: ([S0, S5*S5, 5120]) <- ([S0, S5*S5, 10240])
        #  data: (None) <- (None)
        ...
        # shape: ([3]) <- ([S0, S5*S5, 5120])
        #  data: ([S0, S5*S5, 5120]) <- (None)
        ...
        # shape: ([S0, S5*S5, 5120]) <- ([], [3])
        #  data: (None) <- ([0], [S0, S5*S5, 5120])
        ...
        # shape: ([S0, S5*S5, 5120]) <- ([S0, S5*S5, 5120], [S0, S5*S5, 5120])
        #  data: (None) <- (None, None)
        ...
        # shape: ([S0, S5*S5, 5120]) <- ([S0, S5*S5, 5120])
        #  data: (None) <- (None)
