...
class PrimitiveOp0(paddle.nn.Layer):
    ...
    def forward(self, input_0):
        return paddle.sqrt(input_0)

class TestPrimitiveOp0(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor([[[0.150089830160141], [0.083548903465271], [0.39898940920829773], [0.33701303601264954], [0.5280479788780212], [0.2934713661670685]]], dtype='float32').reshape([1, 6, 1]),
        ]
...
class TestPrimitiveOp1(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor([[[0.20173528790473938], [0.013034983538091183], [0.20383387804031372], [0.43579015135765076], [0.46098506450653076], [0.2537524402141571]]], dtype='float32').reshape([1, 6, 1]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
