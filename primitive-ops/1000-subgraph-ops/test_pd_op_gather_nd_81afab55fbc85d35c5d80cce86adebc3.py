...
class TestPrimitiveOp0(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.uniform([1, 25920, 128], dtype='float32', min=-0.5, max=0.5),
            paddle.randint(low=0, high=2, shape=[1, 500, 2], dtype='int64'),
        ]
...
class TestPrimitiveOp1(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.uniform([1, 41344, 128], dtype='float32', min=-0.5, max=0.5),
            paddle.randint(low=0, high=2, shape=[1, 500, 2], dtype='int64'),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp2(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.uniform([1, 11520, 128], dtype='float32', min=-0.5, max=0.5),
            paddle.randint(low=0, high=2, shape=[1, 500, 2], dtype='int64'),
        ]
        for input in self.inputs:
            input.stop_gradient = True
