...
class TestPrimitiveOp4(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.uniform([1], dtype='float32', min=-0.5, max=0.5),
            paddle.to_tensor([1543, 1], dtype='int32').reshape([2]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp12(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.uniform([1], dtype='float32', min=-0.5, max=0.5),
            paddle.to_tensor([2345, 1], dtype='int32').reshape([2]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp61(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.uniform([1], dtype='float32', min=-0.5, max=0.5),
            paddle.to_tensor([1991, 1], dtype='int32').reshape([2]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp99(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.uniform([1], dtype='float32', min=-0.5, max=0.5),
            paddle.to_tensor([1746, 1], dtype='int32').reshape([2]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp113(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.uniform([1], dtype='float32', min=-0.5, max=0.5),
            paddle.to_tensor([2997, 1], dtype='int32').reshape([2]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp130(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.uniform([1], dtype='float32', min=-0.5, max=0.5),
            paddle.to_tensor([2065, 1], dtype='int32').reshape([2]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp200(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.uniform([1], dtype='float32', min=-0.5, max=0.5),
            paddle.to_tensor([5591, 1], dtype='int32').reshape([2]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp210(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.uniform([1], dtype='float32', min=-0.5, max=0.5),
            paddle.to_tensor([1054, 1], dtype='int32').reshape([2]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp227(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.uniform([1], dtype='float32', min=-0.5, max=0.5),
            paddle.to_tensor([1754, 1], dtype='int32').reshape([2]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp275(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.uniform([1], dtype='float32', min=-0.5, max=0.5),
            paddle.to_tensor([4120, 1], dtype='int32').reshape([2]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp315(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.uniform([1], dtype='float32', min=-0.5, max=0.5),
            paddle.to_tensor([4607, 1], dtype='int32').reshape([2]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp323(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.uniform([1], dtype='float32', min=-0.5, max=0.5),
            paddle.to_tensor([3844, 1], dtype='int32').reshape([2]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
