...
class TestPrimitiveOp3(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            ...
            paddle.to_tensor([[[0.0106635931879282], [-0.01116062793880701], [-0.07064303755760193], [-0.03298785537481308], [-0.022133124992251396], [0.017794061452150345]]], dtype='float32').reshape([1, 6, 1]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp4(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.uniform([1, 6, 21824], dtype='float32', min=-0.5, max=0.5),
            paddle.to_tensor([[[0.016616882756352425], [-0.0006877689156681299], [-0.02579537406563759], [-0.04850652068853378], [-0.01805356703698635], [0.014306778088212013]]], dtype='float32').reshape([1, 6, 1]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp5(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.uniform([1, 6, 21824], dtype='float32', min=-0.5, max=0.5),
            paddle.to_tensor([[[0.09602303802967072], [-0.24197819828987122], [-0.14676618576049805], [-0.08828416466712952], [-0.030201705172657967], [0.058603718876838684]]], dtype='float32').reshape([1, 6, 1]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp10(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor([[0.1804981827735901, -0.2647629380226135, 0.3630751371383667, 0.40568310022354126], [-0.29316195845603943, -0.11278054118156433, 0.47676515579223633, -0.20981177687644958]], dtype='float32').reshape([2, 4]),
            paddle.to_tensor([[0.17548531293869019, 0.4645349979400635, 0.025521934032440186, 0.10976296663284302], [-0.0889534056186676, -0.22897297143936157, 0.24747896194458008, -0.1582818329334259]], dtype='float32').reshape([2, 4]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp14(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor(2014.4832763671875, dtype='float32').reshape([]),
            paddle.to_tensor(6044.0, dtype='float32').reshape([]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp17(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor(-13506.23046875, dtype='float32').reshape([]),
            paddle.to_tensor([0.13596844673156738], dtype='float32').reshape([1]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp19(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor(-86.45217895507812, dtype='float32').reshape([]),
            paddle.to_tensor([0.13596844673156738], dtype='float32').reshape([1]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp20(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor(3160.51611328125, dtype='float32').reshape([]),
            paddle.to_tensor(9524.0, dtype='float32').reshape([]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp23(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor(2487.651123046875, dtype='float32').reshape([]),
            paddle.to_tensor([-0.4975756108760834], dtype='float32').reshape([1]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp25(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor(8.151885986328125, dtype='float32').reshape([]),
            paddle.to_tensor([-0.4975756108760834], dtype='float32').reshape([1]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp55(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor([[0.021614929661154747], [-0.2686476409435272], [-0.16307030618190765], [0.020124994218349457]], dtype='float32').reshape([4, 1]),
...
class TestPrimitiveOp56(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor(2.9303789138793945, dtype='float32').reshape([]),
...
class TestPrimitiveOp59(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            ...
            paddle.to_tensor([0.39444097876548767, 0.18134799599647522, 0.0010218697134405375, 0.6001282930374146, 0.8301284313201904, 0.29913341999053955], dtype='float32').reshape([6]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp61(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor([0.11427444219589233, 0.2184600532054901, -0.2929788827896118, -0.5691602826118469, 0.7080498933792114, -0.05760511755943298], dtype='float32').reshape([6]),
            paddle.to_tensor([0.03544685244560242, 0.07822561264038086, -0.5431261658668518, -0.35877466201782227, 0.01784336566925049, 0.54332435131073], dtype='float32').reshape([6]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp63(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor(17.255859375, dtype='float32').reshape([]),
...
class TestPrimitiveOp65(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor(-1.9672737121582031, dtype='float32').reshape([]),
            paddle.to_tensor([4.0], dtype='float32').reshape([1]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp83(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor([[0.19020074605941772, 0.04631054401397705, 0.358132004737854, -0.41948992013931274], [-0.36952275037765503, 0.22231227159500122, -0.42400622367858887, 0.23829561471939087]], dtype='float32').reshape([2, 4]),
            paddle.to_tensor([[-0.23015323281288147, 0.2008533477783203, -0.1623118817806244, 0.03900963068008423], [-0.13472601771354675, -0.2395024299621582, 0.04400867223739624, -0.18912231922149658]], dtype='float32').reshape([2, 4]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp87(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            ...
            paddle.to_tensor([[[10365.1943359375], [10337.99609375], [10369.8564453125], [10362.98046875], [10332.9453125], [10354.705078125], [10379.28515625], [10379.1669921875], [10381.5458984375], [10349.3984375], [10362.51953125], [10372.8994140625], [10337.90625], [10378.28515625], [10355.3076171875], [10365.2548828125], [10369.2607421875], [10370.2138671875], [10349.2060546875], [10369.1728515625], [10313.7236328125]]], dtype='float32').reshape([1, 21, 1]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp98(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor([[-0.30061691999435425], [0.013743320479989052], [0.41357421875], [-0.024778347462415695], [-0.008820340037345886], [0.07606813311576843]], dtype='float32').reshape([6, 1]),
...
class TestPrimitiveOp127(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor(0.6969374418258667, dtype='float32').reshape([]),
...
class TestPrimitiveOp150(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor(2750.009521484375, dtype='float32').reshape([]),
            paddle.to_tensor(8216.0, dtype='float32').reshape([]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp153(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor(7670.98388671875, dtype='float32').reshape([]),
            paddle.to_tensor([-0.4718933701515198], dtype='float32').reshape([1]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp155(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor(-680.5836791992188, dtype='float32').reshape([]),
            paddle.to_tensor([-0.4718933701515198], dtype='float32').reshape([1]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp170(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor([[0.6244908571243286], [0.5042616128921509], [0.22506392002105713], [0.17914648354053497], [0.14679373800754547]], dtype='float32').reshape([5, 1]),
...
class TestPrimitiveOp173(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor(2360.5830078125, dtype='float32').reshape([]),
            paddle.to_tensor(7108.0, dtype='float32').reshape([]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp176(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor(-769.83447265625, dtype='float32').reshape([]),
            paddle.to_tensor([-0.16604217886924744], dtype='float32').reshape([1]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp178(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor(206.49917602539062, dtype='float32').reshape([]),
            paddle.to_tensor([-0.16604217886924744], dtype='float32').reshape([1]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp193(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor(4080.63232421875, dtype='float32').reshape([]),
            paddle.to_tensor(12220.0, dtype='float32').reshape([]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp196(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor(-24757.23046875, dtype='float32').reshape([]),
            paddle.to_tensor([-0.19889244437217712], dtype='float32').reshape([1]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp198(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor(-227.61070251464844, dtype='float32').reshape([]),
            paddle.to_tensor([-0.19889244437217712], dtype='float32').reshape([1]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp217(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor([[0.6345971822738647], [0.009134314954280853], [0.09085473418235779], [0.11974136531352997], [0.13755469024181366], [-0.07619859278202057], [0.021472901105880737], [0.17804081737995148], [0.008327040821313858]], dtype='float32').reshape([9, 1]),
...
class TestPrimitiveOp218(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            ...
            paddle.to_tensor([[[20729.43359375], [20771.857421875], [20738.24609375], [20709.078125], [20663.732421875], [20724.712890625], [20700.28515625], [20676.072265625], [20746.05078125], [20622.00390625], [20762.68359375], [20733.85546875], [20634.822265625], [20769.4453125], [20741.296875], [20715.357421875], [20639.232421875], [20812.5234375], [20728.8984375]]], dtype='float32').reshape([1, 19, 1]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp230(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor(2805.93359375, dtype='float32').reshape([]),
            paddle.to_tensor(8372.0, dtype='float32').reshape([]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp233(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor(-108677.0, dtype='float32').reshape([]),
            paddle.to_tensor([-0.30865687131881714], dtype='float32').reshape([1]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp235(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor(-361.7497253417969, dtype='float32').reshape([]),
            paddle.to_tensor([-0.30865687131881714], dtype='float32').reshape([1]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp248(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor(1.2346322536468506, dtype='float32').reshape([]),
...
class TestPrimitiveOp259(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor(1.17920982837677, dtype='float32').reshape([]),
...
class TestPrimitiveOp270(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor([[0.222154438495636]], dtype='float32').reshape([1, 1]),
...
class TestPrimitiveOp299(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor(-0.9499496221542358, dtype='float32').reshape([]),
            paddle.to_tensor([7.0], dtype='float32').reshape([1]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp302(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor(7450.3583984375, dtype='float32').reshape([]),
            paddle.to_tensor(22168.0, dtype='float32').reshape([]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp305(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor(-826.67041015625, dtype='float32').reshape([]),
            paddle.to_tensor([0.4074314832687378], dtype='float32').reshape([1]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp307(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor(-23.158458709716797, dtype='float32').reshape([]),
            paddle.to_tensor([0.4074314832687378], dtype='float32').reshape([1]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp313(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor(1461.8394775390625, dtype='float32').reshape([]),
            paddle.to_tensor(4320.0, dtype='float32').reshape([]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp316(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor(15557.6328125, dtype='float32').reshape([]),
            paddle.to_tensor([-0.18496692180633545], dtype='float32').reshape([1]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp318(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor(40.329750061035156, dtype='float32').reshape([]),
            paddle.to_tensor([-0.18496692180633545], dtype='float32').reshape([1]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp321(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor(2298.5048828125, dtype='float32').reshape([]),
            paddle.to_tensor(6936.0, dtype='float32').reshape([]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp324(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor(365786.46875, dtype='float32').reshape([]),
            paddle.to_tensor([-0.37854960560798645], dtype='float32').reshape([1]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp326(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor(124.85054779052734, dtype='float32').reshape([]),
            paddle.to_tensor([-0.37854960560798645], dtype='float32').reshape([1]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp348(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor(0.8998499512672424, dtype='float32').reshape([]),
            paddle.to_tensor([7.0], dtype='float32').reshape([1]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp381(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor(-3.457204818725586, dtype='float32').reshape([]),
...
class TestPrimitiveOp382(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor(0.3380711078643799, dtype='float32').reshape([]),
            paddle.to_tensor([1.0], dtype='float32').reshape([1]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp392(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor(5568.263671875, dtype='float32').reshape([]),
            paddle.to_tensor(16760.0, dtype='float32').reshape([]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp395(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor(81615.703125, dtype='float32').reshape([]),
            paddle.to_tensor([0.26635634899139404], dtype='float32').reshape([1]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp397(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor(-200.54925537109375, dtype='float32').reshape([]),
            paddle.to_tensor([0.26635634899139404], dtype='float32').reshape([1]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp405(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor(0.12636615335941315, dtype='float32').reshape([]),
...
class TestPrimitiveOp418(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor(-13.490816116333008, dtype='float32').reshape([]),
...
class TestPrimitiveOp419(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor(6036.52685546875, dtype='float32').reshape([]),
            paddle.to_tensor(18176.0, dtype='float32').reshape([]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp422(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor(39884.578125, dtype='float32').reshape([]),
            paddle.to_tensor([-0.07519122958183289], dtype='float32').reshape([1]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp424(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor(-215.56109619140625, dtype='float32').reshape([]),
            paddle.to_tensor([-0.07519122958183289], dtype='float32').reshape([1]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp432(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor(5124.73779296875, dtype='float32').reshape([]),
            paddle.to_tensor(15332.0, dtype='float32').reshape([]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp435(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor(114151.8046875, dtype='float32').reshape([]),
            paddle.to_tensor([0.023780345916748047], dtype='float32').reshape([1]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp437(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.to_tensor(-260.0127258300781, dtype='float32').reshape([]),
            paddle.to_tensor([0.023780345916748047], dtype='float32').reshape([1]),
        ]
        for input in self.inputs:
            input.stop_gradient = True
