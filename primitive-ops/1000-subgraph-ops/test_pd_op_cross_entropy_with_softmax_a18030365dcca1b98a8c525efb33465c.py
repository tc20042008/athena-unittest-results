...
class TestPrimitiveOp0(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.uniform([1511, 4, 17], dtype='float32', min=-0.5, max=0.5),
            paddle.randint(low=0, high=2, shape=[1511, 4, 1], dtype='int64'),
        ]
...
class TestPrimitiveOp2(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.uniform([2381, 4, 17], dtype='float32', min=-0.5, max=0.5),
            paddle.randint(low=0, high=2, shape=[2381, 4, 1], dtype='int64'),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp6(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.uniform([2054, 4, 17], dtype='float32', min=-0.5, max=0.5),
            paddle.randint(low=0, high=2, shape=[2054, 4, 1], dtype='int64'),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp10(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.uniform([1777, 4, 19], dtype='float32', min=-0.5, max=0.5),
            paddle.randint(low=0, high=2, shape=[1777, 4, 1], dtype='int64'),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp15(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.uniform([3055, 4, 17], dtype='float32', min=-0.5, max=0.5),
            paddle.randint(low=0, high=2, shape=[3055, 4, 1], dtype='int64'),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp17(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.uniform([2093, 4, 17], dtype='float32', min=-0.5, max=0.5),
            paddle.randint(low=0, high=2, shape=[2093, 4, 1], dtype='int64'),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp19(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.uniform([5542, 4, 17], dtype='float32', min=-0.5, max=0.5),
            paddle.randint(low=0, high=2, shape=[5542, 4, 1], dtype='int64'),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp21(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.uniform([1080, 4, 17], dtype='float32', min=-0.5, max=0.5),
            paddle.randint(low=0, high=2, shape=[1080, 4, 1], dtype='int64'),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp23(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.uniform([1734, 4, 17], dtype='float32', min=-0.5, max=0.5),
            paddle.randint(low=0, high=2, shape=[1734, 4, 1], dtype='int64'),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp28(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.uniform([4190, 4, 17], dtype='float32', min=-0.5, max=0.5),
            paddle.randint(low=0, high=2, shape=[4190, 4, 1], dtype='int64'),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp30(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.uniform([4544, 4, 17], dtype='float32', min=-0.5, max=0.5),
            paddle.randint(low=0, high=2, shape=[4544, 4, 1], dtype='int64'),
        ]
        for input in self.inputs:
            input.stop_gradient = True
...
class TestPrimitiveOp32(CinnTestBase, unittest.TestCase):
    def prepare_data(self):
        self.inputs = [
            paddle.uniform([3833, 4, 17], dtype='float32', min=-0.5, max=0.5),
            paddle.randint(low=0, high=2, shape=[3833, 4, 1], dtype='int64'),
        ]
        for input in self.inputs:
            input.stop_gradient = True
